...
export function DefencePage() {
  return (
    <SectorPageTemplate
      ...
      technologies={[
        { icon: '🛸', label: 'Tactical UAVs', description: 'Fixed-wing and rotary ISR platforms for forward reconnaissance and target acquisition.', path: '/products/uav-systems' },
        { icon: '🧠', label: 'Target AI', description: 'Real-time target detection and tracking AI operating on embedded edge hardware.', path: '/products/artificial-intelligence' },
        { icon: '🎮', label: 'C2 Software', description: 'Encrypted ground control station and mission planning software.', path: '/products/software-systems' },
        { icon: '🔧', label: 'Field Hardware', description: 'Ruggedised electronics and structures built to MIL-STD-810 standards.', path: '/products/advanced-engineering' },
      ]}
    />
  )
}
...
export function SmartCitiesPage() {
  return (
    <SectorPageTemplate
      ...
      technologies={[
        { icon: '🚁', label: 'Urban UAV Fleet', description: 'Low-noise electric drones optimised for urban flight corridors and public safety operations.', path: '/products/uav-systems' },
        { icon: '👁', label: 'Video Analytics', description: 'AI crowd density, anomaly detection, and licence plate recognition from aerial feeds.', path: '/products/artificial-intelligence' },
        { icon: '📊', label: 'City Dashboard', description: 'Unified operations centre software aggregating all sensor and UAV feeds.', path: '/products/software-systems' },
        { icon: '📡', label: 'Comms Infrastructure', description: 'Mesh radio and 4G/5G datalink integration for city-wide drone connectivity.', path: '/products/advanced-engineering' },
      ]}
    />
  )
}
...
export function MunicipalPage() {
  return (
    <SectorPageTemplate
      ...
      challenges={[
        { icon: '🏗', title: 'Asset Inventory Gaps', description: 'Maintaining accurate, up-to-date records of all public infrastructure assets across large geographic areas.' },
        ...
        { icon: '📋', title: 'Reporting Requirements', description: 'Generating audit-quality inspection reports and documentation for regulatory compliance and public accountability.' },
      ]}
      technologies={[
        { icon: '🗺', label: 'Mapping UAVs', description: 'Photogrammetry drones delivering centimetre-accuracy 3D maps of municipal assets.', path: '/products/uav-systems' },
        { icon: '🔍', label: 'Defect Detection AI', description: 'Automated crack, pothole, and structural defect identification from aerial imagery.', path: '/products/artificial-intelligence' },
        { icon: '📁', label: 'Asset Management', description: 'Municipal asset register software with inspection history, scheduling, and work order generation.', path: '/products/software-systems' },
        { icon: '📸', label: 'Survey Sensors', description: 'High-resolution RGB, multispectral, and LiDAR payloads for comprehensive asset surveys.', path: '/products/advanced-engineering' },
      ]}
    />
  )
}
...
export function InfrastructurePage() {
  return (
    <SectorPageTemplate
      ...
      challenges={[
        { icon: '⚡', title: 'Hazardous Access', description: 'Inspecting energised power lines, elevated structures, and confined spaces that pose serious risk to human inspectors.' },
        { icon: '📏', title: 'Linear Scale', description: 'Covering hundreds or thousands of kilometres of pipeline, railway, or powerline efficiently and repeatedly.' },
        { icon: '🌡', title: 'Thermal Anomalies', description: 'Detecting heat signatures indicating electrical faults, corrosion, or mechanical wear before failures occur.' },
        { icon: '📄', title: 'Regulatory Compliance', description: 'Meeting statutory inspection frequency requirements and maintaining audit trails for regulatory bodies.' },
      ]}
      technologies={[
        { icon: '✈', label: 'Fixed-Wing UAV', description: 'Long-endurance fixed-wing platforms covering 200+ km per sortie for linear infrastructure surveys.', path: '/products/uav-systems' },
        { icon: '🌡', label: 'Thermal AI', description: 'AI analysis of thermal imagery to detect electrical faults, corrosion, and structural anomalies.', path: '/products/artificial-intelligence' },
        { icon: '📊', label: 'Inspection Reports', description: 'Automated inspection report generation with GPS-tagged defect locations and severity classifications.', path: '/products/software-systems' },
        { icon: '🔭', label: 'Multi-Sensor Payload', description: 'Integrated thermal, visual, and LiDAR sensor packages for comprehensive infrastructure assessment.', path: '/products/advanced-engineering' },
      ]}
    />
  )
}
...
export function AgriculturePage() {
  return (
    <SectorPageTemplate
      ...
      challenges={[
        { icon: '🌾', title: 'Crop Health Monitoring', description: 'Detecting disease, pest infestation, and nutrient deficiency across large farming areas before visible damage occurs.' },
        { icon: '💧', title: 'Water Efficiency', description: 'Targeting irrigation precisely to areas of moisture stress rather than applying uniformly across entire fields.' },
        ...
        { icon: '📈', title: 'Yield Prediction', description: 'Generating accurate pre-harvest yield estimates to optimise supply chain planning and commodity management.' },
      ]}
      technologies={[
        { icon: '🌿', label: 'Spray Drones', description: 'High-capacity agricultural spray UAVs covering 10 hectares per hour with precision application.', path: '/products/uav-systems' },
        { icon: '🔬', label: 'Crop AI', description: 'Multispectral AI models for NDVI mapping, disease classification, and yield prediction.', path: '/products/artificial-intelligence' },
        { icon: '📱', label: 'Farm Dashboard', description: 'Field-by-field analytics portal with prescription maps and application records.', path: '/products/software-systems' },
        { icon: '🌈', label: 'Multispectral Sensor', description: 'Six-band multispectral cameras capturing data beyond visible spectrum for crop health analysis.', path: '/products/advanced-engineering' },
      ]}
    />
  )
}
  ...
  return (
    <SectorPageTemplate
      ...
      challenges={[
        ...
        { icon: '📡', title: 'Comms Infrastructure Loss', description: 'Operating when terrestrial communications, roads, and power infrastructure are destroyed by the disaster.' },
        { icon: '🔍', title: 'Survivor Location', description: 'Detecting and locating survivors in collapsed structures, floodwater, or remote terrain rapidly.' },
        { icon: '🚁', title: 'Airspace Coordination', description: 'Operating safely alongside manned rescue helicopters and military aviation in uncontrolled airspace.' },
      ]}
      technologies={[
        { icon: '📦', label: 'Rapid Deploy Kit', description: 'Man-portable UAV systems deployable by two operators in under 20 minutes.', path: '/products/uav-systems' },
        { icon: '🧑‍🤝‍🧑', label: 'Survivor Detection AI', description: 'Thermal AI models trained to identify human heat signatures in debris and water.', path: '/products/artificial-intelligence' },
        { icon: '🗺', label: 'Relief Dashboard', description: 'Real-time damage mapping and resource allocation software for relief coordinators.', path: '/products/software-systems' },
        { icon: '📡', label: 'SATCOM Datalink', description: 'Satellite communication-enabled datalinks for beyond-line-of-sight operations in remote areas.', path: '/products/advanced-engineering' },
      ]}
    />
  )
}
...
export function EnvironmentalPage() {
  return (
    <SectorPageTemplate
      ...
      challenges={[
        { icon: '🌍', title: 'Scale of Coverage', description: 'Monitoring vast forest, coastal, and watershed areas that are impractical to survey with manned resources.' },
        { icon: '💨', title: 'Emissions Detection', description: 'Detecting and quantifying industrial emissions, methane leaks, and air pollutants at the source level.' },
        { icon: '🐘', title: 'Wildlife Monitoring', description: 'Conducting population surveys and tracking of endangered species with minimal ecological disturbance.' },
        { icon: '📜', title: 'Compliance Reporting', description: 'Generating auditable environmental impact data for regulatory submission and ESG reporting frameworks.' },
      ]}
      technologies={[
        { icon: '🌿', label: 'Survey UAV', description: 'Fixed-wing platforms for large-area ecological and environmental baseline surveys.', path: '/products/uav-systems' },
        { icon: '🔬', label: 'Species AI', description: 'Computer vision models for wildlife species identification and population counting from aerial imagery.', path: '/products/artificial-intelligence' },
        ...
        { icon: '🧪', label: 'Gas Sensors', description: 'Miniaturised gas detection payloads for methane, CO2, and pollutant concentration mapping.', path: '/products/advanced-engineering' },
      ]}
    />
  )
}
...
export function IndustrialPage() {
  return (
    <SectorPageTemplate
      ...
      challenges={[
        { icon: '⚠', title: 'Worker Safety Risk', description: 'Eliminating human exposure to heights, confined spaces, toxic atmospheres, and energised equipment during inspection.' },
        { icon: '🏭', title: 'Production Continuity', description: 'Conducting inspections without shutting down production, avoiding costly planned and unplanned downtime.' },
        { icon: '🔩', title: 'Corrosion & Defect Detection', description: 'Identifying early-stage corrosion, coating failure, and structural defects before they become critical failures.' },
        { icon: '📊', title: 'Digital Twin Integration', description: 'Feeding inspection data into 3D digital twins and asset management systems for predictive maintenance.' },
      ]}
      technologies={[
        { icon: '🏗', label: 'Industrial UAV', description: 'Confined-space and ex-zone rated UAVs for tank, vessel, and facility inspection.', path: '/products/uav-systems' },
        { icon: '🔍', label: 'Corrosion AI', description: 'AI models for automated corrosion grading, coating assessment, and anomaly classification.', path: '/products/artificial-intelligence' },
        { icon: '🔧', label: 'Maintenance Platform', description: 'Work order generation and predictive maintenance scheduling driven by inspection AI outputs.', path: '/products/software-systems' },
        { icon: '📡', label: 'NDT Sensors', description: 'Ultrasonic, eddy current, and radiographic NDT sensor payloads for non-contact material testing.', path: '/products/advanced-engineering' },
      ]}
    />
  )
}
