...
export function DefencePage() {
  return (
    <SectorPageTemplate
      ...
      backgroundVideoMp4="/Sector1.mp4"  //video
      stats={[
...
export function SmartCitiesPage() {
  return (
    <SectorPageTemplate
      ...
      backgroundVideoMp4="/Sector2.mp4"  //video
      stats={[
...
export function MunicipalPage() {
  return (
    <SectorPageTemplate
      ...
      backgroundVideoMp4="/Sector3.mp4"  //video
      stats={[
...
export function InfrastructurePage() {
  return (
    <SectorPageTemplate
      ...
      backgroundVideoMp4="/Sector4.mp4"  //video
      stats={[
...
export function AgriculturePage() {
  return (
    <SectorPageTemplate
      ...
      backgroundVideoMp4="/Sector5.mp4"  //video
      stats={[
...
export function DisasterPage() {
  return (
    <SectorPageTemplate
      ...
      backgroundVideoMp4="/Sector6.mp4"  //video
      stats={[
...
export function EnvironmentalPage() {
  return (
    <SectorPageTemplate
      ...
      backgroundVideoMp4="/Sector7.mp4"  //video
      stats={[
...
export function IndustrialPage() {
  return (
    <SectorPageTemplate
      ...
      backgroundVideoMp4="/Sector8.mp4"  //video
      stats={[
