...
export function SoftwarePage() {
  return (
    <ProductPageTemplate
      ...
      features={[
        { icon: '🎮', title: 'Ground Control Station',  description: 'Full-featured GCS for UAV fleet management, mission planning, telemetry monitoring, and payload control.' },
        { icon: '🗺', title: 'Mission Planning Suite',  description: 'Advanced route planning with terrain analysis, threat overlay, and multi-platform deconfliction tools.' },
